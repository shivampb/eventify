...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">EVENTIFY </a>
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="./signup.php">Sign Up</a>
          </li>
          <li class=" nav-item">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">EVENTIFY </h1>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="service-box" style="background-image:url(img/venue.jpg); background-size: cover;">
            ...
            <div class="service-content ">
              <h2 class="s-title"> <b><a href="#venue" class="s-title text-white">Venue</a></b></h2>
        ...
        <div class="col-md-4">
          <div class="service-box" style="background-image:url(img/theme.jpg); background-size: cover;">
            ...
            <div class="service-content ">
              <h2 class="s-title text-white"> <b><a href="#theme" class="text-white"> Theme</a></b></h2>
              <!-- <h2 class="s-title"> <b><a href="#venue" class="s-title text-white">Venue</a></b></h2> -->
              <p class="s-description text-center text-white"><b>
                </b>
              </p>
        ...
        <div class="col-md-4">
          <div class="service-box" style="background-image:url(img/cat.jpg); background-size: cover;">
            ...
            <div class="service-content ">
              <h2 class="s-title text-white"> <b><a href="#catering" class="text-white">Catering </a></b></h2>
        ...
        <div class="col-md-4">
          <div class="service-box" style="background-image:url(img/dj.jpg); background-size: cover;">
            ...
            <div class="service-content ">
              <h2 class="s-title text-white"> <b><a href="#music" class="text-white">Music </a></b></h2>
        ...
        <div class="col-md-4">
          <div class="service-box" style="background-image:url(img/photo.jpg); background-size: cover;">
            ...
            <div class="service-content ">
              <h2 class="s-title text-white"> <b><a href="#photoshop" class="text-white">photoshop </a></b></h2>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  ...
                  <p class="lead">
                    hum ider shadi karate hai to tumne shadi karni hai to, na na beta ladki to tuje hi lani padegi hum khali shadi karaye ge we re not "R
                  </p>
                </div>
              </div>
            </div>
            ...
            <div id="contact" class="box-shadow-full">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    <p class="lead">
                      Ahemdabad Headquater
                    </p>
                    <ul class="list-ico">
                      <li><span class="ion-ios-location"></span>setan gali, andheri nager, shamshan ke samne</li>
                      <li><span class="ion-ios-telephone"></span> ++9100000000</li>
                      <li><span class="ion-email"></span> eventify@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>EVENTIFY </strong>. All Rights Reserved</p>
              <div class="credits">

                Designed by <a href="#">Shivam Bhardwaj</a>
              </div>
            </div>
          </div>
        </div>
